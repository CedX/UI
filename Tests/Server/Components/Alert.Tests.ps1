...
Describe "New-Alert" {
	It 'should handle the "Class" parameter' {
		Should-BeLikeString "*mb-0 rounded-0*" (New-UIAlert -Class mb-0, rounded-0) -CaseSensitive
	}
	...
	It 'should handle the "Fade" parameter' {
		Should-BeLikeString "*fade show*" (New-UIAlert -Fade) -CaseSensitive
	}

	It 'should handle the "Icon" parameter' {
		Should-BeLikeString "*<i*>heart</i>*" (New-UIAlert -Icon heart) -CaseSensitive
	}

	It "should handle the inner content" {
		Should-BeLikeString '*<input type="text">*' (New-UIAlert { input -Type text }) -CaseSensitive
	}
}
